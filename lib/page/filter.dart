 ...
 /* Future<QueryParametersModels> _getDropDownData() async {
  ...
  Future<QueryParametersModels> getList() async {
    ...
    if (response.statusCode == 200) {
      dataJson = QueryParametersModels.fromJson(data);
     ...
     temperaments = dataJson.temperaments!;*/
      setState(() {
        ...
        value = dataJson.idealHeightsRange!.toJson().keys.toList();
      ...
      /*Map<String, List<String>> typedMap = dataJson.idealWeightsRange! as Map<String, List<String>>;
      print(typedMap);*/




     /* List temp = (data['ideal_weights_range'] as List)
          .map((itemWord) => IdealWeightsRange.fromJson(itemWord))
          .toList();
