...
class RecentHistoryResultShow extends StatefulWidget {
  Data data;

  RecentHistoryResultShow(this.data, {Key? key}) : super(key: key);

  @override
  _RecentHistoryResultShowState createState() =>
      _RecentHistoryResultShowState(data);
}

GlobalKey shareContainer = GlobalKey();
GlobalKey shareAnotherContainer = GlobalKey();
var sweepAngle;
bool? isVisible;
...
class _RecentHistoryResultShowState extends State<RecentHistoryResultShow> {
  Data data;
  _RecentHistoryResultShowState(this.data);
  ...
  void initState() {
    ...
    super.initState();
    setState(() {
      FirebaseAnalytics.instance.logEvent(name: 'Recent_History_Screen',parameters: {
        'note':"stay Breed History",
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    double percentage =
        double.parse(data.response!.data!.first.percentage.toString()) / 100;
              ...
              child: Container(
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Positioned(
                              top: top,
                              child: buildProfileImage(percentage)),
                        ],
                      ),
                    ),
                    ...
                    Center(
                      child: Text(data.response!.data!.first.breed.toString(),
                          style: TextStyle(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Material(child: buildCard(context)),
                    ...
                    Padding(
                      ...
                      child: ListView.builder(
                          ...
                          itemCount: null == datas ? 0 : datas.length,
                              ...
                              child: ListTile(
                                ...
                                onTap: () {
                                  if (datas == null) {
                                    ...
                                    print(datas[index].breed);
                                    createAlearDiolog(context, datas[index]);
                                  }
                                },
                              ),
                            );
  ...
  Widget buildCoverImage() {
   ...
   child: ClipRRect(
     ...
     child: CachedNetworkImage(
       imageUrl: data.response!.data!.first.thumbnail.toString(),
  ...
  Widget buildProfileImage(double percentage) => CircularPercentIndicator(
  ...
  Future<void> _captureSocialPng(BuildContext context, DataIndividual individual, String imageShow) {
    List<String> imagePaths = [];
    ...
    return new Future.delayed(const Duration(milliseconds: 20), () async {
      ...
      shareAlertDialog(context,dataList!,imageShow,pngBytes,imgFile);
      /*Navigator.push(context, MaterialPageRoute(builder: (context) => BottomPage(context,dataList!,imageShow,pngBytes,imgFile),),);*/
      ...
      child: Card(
        child: Padding(
          ...
          child: Column(
            children: [
              Container(
                child: DonutChartWidget(data.response!.data!),
              ),
            ],
          ),
        ),
...
shareAlertDialog(BuildContext context, DataIndividual dataList, String image,Uint8List bytes, File imgFile) {
  return showDialog(
      context: context,
...
createAlearDiolog(BuildContext context, DataIndividual dataList) {
  showDialog(
      context: context,
      builder: (BuildContext context) {
        return Dialog(
...
Widget buildImage(DataIndividual data) => ClipRRect(
      ...
      child: Container(
        ...
        children: [
          /*SfCircularChart(
              ...
              series: <CircularSeries<DataIndividual, String>>[
                DoughnutSeries<DataIndividual, String>(

                    selectionBehavior: SelectionBehavior(enable: true),
                    explode: true,
                    dataSource: data,
                    xValueMapper: (DataIndividual data, _) => data.breed,
                    yValueMapper: (DataIndividual data, _) =>
...
class DonutChartPainter extends CustomPainter {
  final List<DataIndividual> data;
