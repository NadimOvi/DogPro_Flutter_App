...
import 'package:dog_breed/LocalDatabase/localDatabasePostModel.dart';
...
class LocalDataShow extends StatefulWidget {
  Data data;
  LocalDataShow(this.data, {Key? key}) : super(key: key);

  @override
  _LocalDataShowState createState() => _LocalDataShowState(data);
}
...
class _LocalDataShowState extends State<LocalDataShow> {
  ...
  void initState() {
    ...
    super.initState();
    setState(() {
      FirebaseAnalytics.instance.logEvent(name: 'Local_History_Screen',parameters: {
        'note':"stay Breed Local History",
      });
    });
  }
                  ...
                  Padding(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Positioned(
                            top: top,
                            child: buildProfileImage(percentage,data)),
                      ],
                    ),
                  ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Material(child: buildCard(context,data.response!.data!)),
...
Widget buildCoverImage(Data data)=>Container(
  child: ClipRRect(
...
Widget buildProfileImage(double percentage, Data data) => CircularPercentIndicator(
...
Widget buildCard(BuildContext context, List<LocalData> data) {
...
Future<void> _captureSocialPng(BuildContext context, LocalData data, String imageShow) {
  List<String> imagePaths = [];
...
shareAlertDialog(BuildContext context, LocalData dataList, String image,Uint8List bytes, File imgFile) {
  return showDialog(
      context: context,
...
createAlearDiolog(BuildContext context, LocalData dataList) {
  showDialog(
      context: context,
      builder: (BuildContext context) {
        return Dialog(
...
Widget buildImage(LocalData data) => ClipRRect(
      ...
      child: Container(
        ...
        children: [
          /*SfCircularChart(
              ...
              series: <CircularSeries<LocalData, String>>[
                DoughnutSeries<LocalData, String>(
                    selectionBehavior: SelectionBehavior(enable: true),
                    explode: true,
                    dataSource: data,
                    xValueMapper: (LocalData data, _) => data.breed,
                    yValueMapper: (LocalData data, _) =>
